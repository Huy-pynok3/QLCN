...
import com.qlcnnh.DAO.StatisticalDAO;
...
public class Form_Home extends javax.swing.JPanel {
 ...
 StatisticalDAO sDao = new StatisticalDAO();
    ...
    private void initCardData() {
        ...
        card2.setData(new ModelCard("Sổ tiết kiệm/Ngày", sDao.getSumSaving(), 60, icon2));
        Icon icon3 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.SHOPPING_BASKET, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card3.setData(new ModelCard("Số hợp đồng/Ngày", 3000, 80, icon3));
        Icon icon4 = IconFontSwing.buildIcon(GoogleMaterialDesignIcons.BUSINESS_CENTER, 60, new Color(255, 255, 255, 100), new Color(255, 255, 255, 15));
        card4.setData(new ModelCard("Khác", 550, 95, icon4));
    }

    private void initNoticeBoard() {
        noticeBoard.addDate("Quy định");
        noticeBoard.addNoticeBoard(new ModelNoticeBoard(new Color(94, 49, 238), "Lưu ý", "Now", "Thời gian hoạt động vào các ngày trong tuần từ thứ 2 đến thứ 6 và thứ 7 đối với một số các chi nhánh khác."));
        noticeBoard.addNoticeBoard(new ModelNoticeBoard(new Color(218, 49, 238), "Thời gian làm việc", "2h ago", "Sáng bắt đầu từ 8h00 tới 12h00\n" +
"Chiều bắt đầu từ 13h00 tới 16h30"));
//        noticeBoard.addDate("03/10/2021");
    ...
    private void initComponents() {
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tên khách hàng", "Giới tính", "Số thoại", "Địa chỉ"
            }
        ) {
