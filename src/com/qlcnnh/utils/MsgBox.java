...
public class MsgBox {
    ...
    public static void alert(Component parent, String message) {
        ...
        JOptionPane.showMessageDialog(parent, message, "", JOptionPane.INFORMATION_MESSAGE, icon);
    }
    ...
    public static boolean confirm(Component parent, String message) {
        ...
        int result = JOptionPane.showConfirmDialog(parent, message, "", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, icon);
